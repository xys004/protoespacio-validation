...
\label{eq:target}
\end{equation}
con \(\alpha_i,\beta\) satisfaciendo \eqref{eq:alpha-beta}.
...
\begin{enumerate}[leftmargin=*]
  ...
  \item introducir un termino de masa y verificar que aparece el Hamiltoniano de Dirac \eqref{eq:target}.
\end{enumerate}
