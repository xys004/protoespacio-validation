...
% verified-by: validators/protoespacio_global.py::test_hamiltonian_hermitian
% verified-by: validators/protoespacio_global.py::test_infrared_limit
% verified-by: validators/protoespacio_global.py::test_brillouin_periodicity
% verified-by: validators/protoespacio_global.py::test_wilson_lifts_doublers
...
Si seguimos realmente paso a paso, lo que toca ahora es estudiar la \textbf{consistencia global} del objeto \eqref{c31:eq:protofinal}. Eso significa:
\begin{enumerate}[label=\arabic*.]
