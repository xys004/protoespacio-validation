...
Al ensamblar dos sectores de quiralidad opuesta con masa, obtenemos \eqref{eq:Haniso}. El cuadrado vale
\begin{equation}
H_{\mathrm{aniso}}^2
=
...
La relacion de dispersion \eqref{eq:dispersionAniso} puede escribirse como
\begin{equation}
