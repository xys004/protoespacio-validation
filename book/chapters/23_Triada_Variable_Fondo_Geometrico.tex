...
% verified-by: validators/triada.py::test_diagonal_tetrad_3d
% verified-by: validators/triada.py::test_diagonal_tetrad_2d
% verified-by: validators/triada.py::test_isotropic_cone
% verified-by: validators/triada.py::test_position_dependent_tetrad
...
\label{c23:eq:localDirac}
\end{equation}

\subsection{Primera interpretacion}
La ecuacion \eqref{c23:eq:localDirac} dice que el fermion efectivo ya no ve el mismo cono en todas partes. El cono local cambia con \(\vx\) y con \(n\).
...
La ecuacion \eqref{c23:eq:extraTerm} sugiere dos niveles de lectura.
