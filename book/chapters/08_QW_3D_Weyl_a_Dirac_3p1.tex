...
0 & H_{-W}
\end{pmatrix}.
\label{c08:eq:H0block}
\end{equation}

Usando \eqref{c08:eq:HW} y \eqref{c08:eq:Hminus}, esto equivale a
\begin{equation}
...
\label{c08:eq:alphabeta}
\end{equation}

Entonces \eqref{c08:eq:HD} toma la forma estandar
\begin{equation}
H_D = v\sum_{i=1}^3 \alpha_i p_i + m\beta.
\label{c08:eq:HDstandard}
\end{equation}
...
Las relaciones \eqref{c08:eq:aa} y \eqref{c08:eq:ab} son exactamente las del Hamiltoniano de Dirac. Por tanto, la construccion es consistente.
