...
% verified-by: validators/tiempo_continuo_vs_qw.py::test_trotter_first_order
% verified-by: validators/tiempo_continuo_vs_qw.py::test_trotter_second_order
% verified-by: validators/tiempo_continuo_vs_qw.py::test_unitarity
...
\label{c21:eq:lattice-dirac-cont}
\end{equation}
...
\label{c21:fig:continuous-time-picture}
\end{figure}
...
Comparando con \eqref{c21:eq:Uk-expand}, identificamos
\begin{equation}
H_{\text{eff}}(k)=\frac{a}{\Delta t}k\,\sigma_z + \frac{\theta}{\Delta t}\sigma_y.
\label{c21:eq:Heff-walk}
\end{equation}
