...
El modelo microscópico distingue claramente los ejes \(x,y,z\). Pero el espectro \eqref{eq:disp} solo depende de
\begin{equation}
...
El Hamiltoniano efectivo \eqref{eq:WeylEff} es invariante bajo rotaciones continuas si estas se acompa\~nan con la rotacion espinorial adecuada. El generador total es
\begin{equation}
...
El bloque \eqref{eq:WeylEff} tiene una orientacion definida. En general, si
\begin{equation}
