...
\end{equation}
Usando \eqref{eq:eigenstates} se obtiene
\begin{equation}
\mathcal{A}_\theta=0.
\end{equation}
...
Tomando la banda de valencia y usando \eqref{eq:omegageneral},
\begin{equation}
\bm{\Omega}=
