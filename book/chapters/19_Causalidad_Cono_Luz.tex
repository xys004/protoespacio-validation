...
Usando \eqref{eq:Hrzero}, si \(L=d(\bm{n},\bm{m})\), los terminos con \(r<L\) desaparecen:
\begin{equation}
\mel{\bm{n}}{U(t)}{\bm{m}}
...
Idealmente, no solo queremos \eqref{eq:compat}. Queremos ademas que:
\begin{enumerate}[label=\arabic*.]
