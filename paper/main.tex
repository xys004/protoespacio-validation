...
\title{Emergent Dirac dynamics in \texorpdfstring{$3{+}1$}{(3+1)} dimensions
       ...
       a formally verified pedagogical ladder}
...
manuscript is built under a strict policy: the PDF is only produced if all
$146$ tests pass. We close with two open problems for which a first body
